...
\begin{itemize}
  ...
  \item Diagnosis of drug-induced liver injury (DILI): Hy's Law---ALT >3$\times$ ULN + bilirubin >2$\times$ ULN (in the absence of cholestasis, viral hepatitis, or other cause) indicates high risk of acute liver failure (10--50\% mortality)
...
\begin{itemize}
  ...
  \item \textbf{Hy's Law for drug-induced liver injury:} ALT >3$\times$ ULN + bilirubin >2$\times$ ULN (direct >35\%) in absence of cholestasis or other cause $\rightarrow$ high risk of acute liver failure.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Giannini EG, Testa R, Savarino V. Liver enzyme alteration: a guide for clinicians. CMAJ. 2005;172(3):367--379.
  \item Kamath PS, Kim WR; Advanced Liver Disease Study Group. The Model for End-Stage Liver Disease (MELD). Hepatology. 2007;45(3):797--805.
  \item Pugh RN, Murray-Lyon IM, Dawson JL, et al. Transection of the oesophagus for bleeding oesophageal varices. Br J Surg. 1973;60(8):646--649.
  \item Temple R. Hy's Law: predicting serious hepatotoxicity. Pharmacoepidemiol Drug Saf. 2006;15(4):241--243.
\end{enumerate}
