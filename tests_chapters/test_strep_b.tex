...
Group B Streptococcus (GBS) testing detects \textit{Streptococcus agalactiae}, a gram-positive, catalase-negative, beta-hemolytic coccus classified by Lancefield group B antigen. GBS is a common commensal of the gastrointestinal and genitourinary tracts; 10--30\% of pregnant women are vaginally or rectally colonized. While asymptomatic colonization is the rule in healthy adults, GBS is the leading cause of early-onset neonatal sepsis (EOS, occurring in the first 7 days of life, typically within 24 hours), presenting as bacteremia, pneumonia, and meningitis. EOS results from vertical transmission from colonized mothers during labor and delivery. GBS also causes late-onset neonatal disease (7--90 days, typically meningitis), which may be vertically or nosocomially/community acquired. In adults, GBS causes invasive disease primarily in the elderly, diabetics, immunocompromised patients, and those with malignancy, presenting as bacteremia without focus, skin/soft tissue infection, pneumonia, urinary tract infection, endocarditis, septic arthritis, and meningitis. Universal prenatal screening at 35--37 weeks' gestation and intrapartum antibiotic prophylaxis (IAP) with penicillin G or ampicillin has reduced the incidence of EOS GBS from approximately 1.7 cases per 1,000 live births in the 1990s to 0.22 per 1,000 in 2015, a >85\% reduction.
...
GBS culture at 35--37 weeks is the primary screening test for all pregnant women. Intrapartum NAAT is a primary test for women with unknown GBS status in labor. Blood and CSF cultures are primary tests for suspected neonatal GBS sepsis. Rapid antigen tests are secondary (not recommended) for screening.
