...
\begin{itemize}
  ...
  \item Evaluation of symptoms including fatigue, pallor, dyspnea, tachycardia, dizziness, and headache
\end{itemize}
...
\begin{itemize}
  \item \textbf{Adult males:} 4.35--5.65 $\times$ 10\textsuperscript{6}/$\mu$L (4.35--5.65 $\times$ 10\textsuperscript{12}/L)
...
\begin{enumerate}
  ...
  \item Simel DL, Rennie D. The Rational Clinical Examination: Evidence-Based Clinical Diagnosis. McGraw-Hill; 2009.
\end{enumerate}
