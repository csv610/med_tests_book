...
\section*{Principle}
Detection is by inductively coupled plasma mass spectrometry (ICP-MS), the gold standard for trace and toxic element analysis. Alternative methods include atomic absorption spectroscopy (AAS), especially graphite furnace AAS for lead. Each element has a unique mass-to-charge ratio detected by the mass spectrometer, providing parts-per-billion sensitivity. Whole blood is collected in metal-free EDTA tubes (royal blue-top); urine is collected in acid-washed 24-hour containers.

\section*{History}
Concerns about heavy metal toxicity date to antiquity (lead poisoning in Roman aqueducts, mercury in felters). Occupational exposure limits were established in the 20th century. The U.S. CDC lowered the reference value for lead in children from 10 $\mu$g/dL (2012) to 3.5 $\mu$g/dL (2021), reflecting accumulating evidence of neurocognitive harm at low levels.
...
\begin{itemize}
  ...
  \item \textbf{Chelation therapy and post-chelation monitoring:} Succimer (DMSA), EDTA, BAL (dimercaprol), D-penicillamine, depending on metal
  \item \textbf{Pregnancy and breastfeeding status:} Lead readily crosses placenta
\end{itemize}

\section*{References}
\begin{enumerate}
  \item Centers for Disease Control and Prevention. Blood lead reference value. Updated 2021.
  \item American College of Medical Toxicology. Position statement on post-chelation challenge testing. J Med Toxicol. 2010;6(1):74-78.
  \item Kosnett MJ. Heavy metal intoxication. In: Goldman L, Schafer AI, eds. Goldman-Cecil Medicine. 27th ed. Elsevier; 2024.
  \item U.S. Department of Labor OSHA. Heavy Metals: Lead, Cadmium, Mercury. Occupational Safety Standards.
  \item Nordberg GF, Fowler BA, Nordberg M, eds. Handbook on the Toxicology of Metals. 5th ed. Academic Press; 2022.
\end{enumerate}
