...
This test detects infection by \textit{Helicobacter pylori}, a spiral bacterium that colonizes the stomach lining. H. pylori infection is a major cause of gastritis, peptic ulcer disease, and is associated with gastric cancer.

\section*{Alternative Names}
H. pylori stool antigen, H. pylori breath test, urea breath test, UBT, H. pylori antibody test
...
There are no contraindications for the stool antigen test. The breath test is safe but should be performed with caution in pregnant women if using 14C-urea (which has a tiny dose of radioactivity; 13C-urea is non-radioactive and preferred).

\section*{Risks}
There are no risks associated with the breath or stool tests. Standard venipuncture risks apply to the blood test.

\section*{What Happens After the Test}
If the test is positive, your doctor will prescribe "triple therapy" or "quadruple therapy" consisting of two antibiotics (e.g., clarithromycin, amoxicillin) and a PPI to eradicate the bacterium.
...
Following eradication therapy, a repeat breath or stool test must be performed at least 4 weeks after completion of treatment to confirm successful eradication of the infection.

\section*{References}
\begin{enumerate}
  \item Chey WD, et al. ACG Clinical Guideline: Treatment of Helicobacter pylori Infection. Am J Gastroenterol; 2017.
  \item Malfertheiner P, et al. Management of Helicobacter pylori infection---the Maastricht V/Florence Consensus Report. Gut; 2017.
  \item Crowe SE. Helicobacter pylori Infection. N Engl J Med; 2019.
\end{enumerate}
