...
CMV Serology; CMV IgG/IgM; CMV DNA PCR; CMV Viral Load; CMV Antigenemia; CMV pp65; Cytomegalovirus PCR; CMV Culture; CMV Shell Vial Assay
...
\begin{itemize}
  \item Pre-transplant CMV serologic screening of donors and recipients (D/R serostatus): The most important predictor of post-transplant CMV risk. High-risk: D+/R-; intermediate: D+/R+, D-/R+ (SOT). Guiding prophylaxis versus preemptive therapy strategy
  \item Weekly CMV viral load monitoring in high-risk transplant recipients (HSCT, SOT) for the first 100 days post-transplant (or longer) as part of preemptive therapy strategy: rising CMV DNA or exceeding a center-specific threshold triggers initiation of antiviral therapy to prevent CMV end-organ disease
  ...
  \item Diagnosis of congenital CMV infection: PCR of neonatal urine (within the first 2--3 weeks of life, as detection after 3 weeks may represent postnatal acquisition), saliva, or blood. Dried blood spot (DBS) PCR from newborn screening cards is used for retrospective diagnosis. CMV serology in the pregnant woman with mononucleosis-like illness, fetal ultrasound abnormalities (intracranial calcifications, microcephaly, hepatosplenomegaly, echogenic bowel), or known CMV exposure; IgM, IgG, and IgG avidity testing are essential to estimate timing of maternal infection
...
\section*{References}
\begin{enumerate}
  \item Kotton CN, Kumar D, Caliendo AM, et al. The Third International Consensus Guidelines on the management of cytomegalovirus in solid-organ transplantation. Transplantation. 2018;102(6):900-931.
  \item Ljungman P, de la Camara R, Robin C, et al. Guidelines for the management of cytomegalovirus infection in patients with haematological malignancies and after stem cell transplantation. Lancet Infect Dis. 2019;19(8):e260-e272.
  ...
  \item Lazzarotto T, Guerra B, Lanari M, et al. New advances in the diagnosis of congenital cytomegalovirus infection. J Clin Virol. 2008;41(3):192-197.
  \item Boeckh M, Ljungman P. How we treat cytomegalovirus in hematopoietic cell transplant recipients. Blood. 2009;113(23):5711-5719.
\end{enumerate}
