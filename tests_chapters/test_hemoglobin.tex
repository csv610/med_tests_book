...
Hemoglobin measurement is a primary screening test for anemia and polycythemia and is a core component of the complete blood count.
...
No special preparation is required. Fasting is not necessary for hemoglobin measurement alone, though if other tests requiring fasting (glucose, lipid panel) are ordered simultaneously, the patient should fast for 8--12 hours. Patients should avoid vigorous exercise for 30 minutes prior to testing, as intense exercise can transiently elevate hemoglobin due to plasma volume contraction and splenic contraction. The patient should be seated or supine for at least 5 minutes before venipuncture, as postural changes can alter plasma volume and hemoglobin concentration.
...
\begin{itemize}
  \item \textbf{Adult males:} 13.5--17.5 g/dL (135--175 g/L)
...
\begin{enumerate}
  ...
  \item Schechter AN. Hemoglobin research and the origins of molecular medicine. Blood. 2008;112(10):3927--3938.
\end{enumerate}
