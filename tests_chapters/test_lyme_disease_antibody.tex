...
Standard precautions for venipuncture apply. The test should not be ordered as a general screening tool in patients without clinical symptoms or geographic exposure, as this increases the likelihood of false-positive results.
...
\section*{References}
\begin{enumerate}
  \item Lantos PM, et al. Clinical Practice Guidelines by the Infectious Diseases Society of America (IDSA). Clin Infect Dis; 2021.
  \item Steere AC, et al. Lyme Borreliosis. Nat Rev Dis Primers; 2016.
  \item Centers for Disease Control and Prevention (CDC). Lyme Disease Diagnosis and Testing; 2023.
\end{enumerate}
