...
\begin{itemize}
  \item Suspected meningitis or encephalitis (fever, headache, neck stiffness, altered mental status, photophobia) to confirm infection and identify the organism
  \item Suspected subarachnoid hemorrhage when noncontrast head CT is negative or equivocal
...
\begin{enumerate}
  ...
  \item Freedman MS, Thompson EJ, Deisenhammer F, et al. Recommended standard of cerebrospinal fluid analysis in the diagnosis of multiple sclerosis. Arch Neurol. 2005;62(6):865--870.
  \item Perry JJ, Stiell IG, Wells GA, et al. Clinical decision rules for evaluating subarachnoid hemorrhage. JAMA. 2013;310(12):1248--1255.
  \item Seehusen DA, Reeves MM, Fomin DA. Cerebrospinal fluid analysis. Am Fam Physician. 2003;68(6):1103--1108.
  \item van de Beek D, de Gans J, Spanjaard L, Weisfelt M, Reitsma JB, Vermeulen M. Clinical features and prognostic factors in adults with bacterial meningitis. N Engl J Med. 2004;351(18):1849--1859.
\end{enumerate}
\clearpage
