...
\begin{itemize}
  ...
  \item Percent free PSA (%fPSA) measurement when total PSA is in the diagnostic gray zone (4--10 ng/mL) to improve specificity before proceeding to prostate biopsy. A high %fPSA (>25\%) suggests benign prostatic hyperplasia; a low %fPSA (<10\%) is more suspicious for prostate cancer
...
\begin{itemize}
  ...
  \item PSA velocity: A PSA increase of >0.75 ng/mL per year (or >0.35 ng/mL per year for younger men with PSA <4 ng/mL) is associated with an increased risk of prostate cancer. PSA velocity is used primarily for risk stratification, not as an independent indication for biopsy
...
\section*{References}
\begin{enumerate}
  \item Thompson IM, Pauler DK, Goodman PJ, et al. Prevalence of prostate cancer among men with a prostate-specific antigen level $\leq$4.0 ng per milliliter. N Engl J Med. 2004;350(22):2239--2246.
  \item Catalona WJ, Partin AW, Slawin KM, et al. Use of the percentage of free prostate-specific antigen to enhance differentiation of prostate cancer from benign prostatic disease. JAMA. 1998;279(19):1542--1547.
  \item Heidenreich A, Bastian PJ, Bellmunt J, et al. EAU guidelines on prostate cancer. Part 1: screening, diagnosis, and local treatment with curative intent --- update 2013. Eur Urol. 2014;65(1):124--137.
  \item Grossman DC, Curry SJ, Owens DK, et al. Screening for prostate cancer: US Preventive Services Task Force recommendation statement. JAMA. 2018;319(18):1901--1913.
  \item Kasivisvanathan V, Rannikko AS, Borghi M, et al. MRI-targeted or standard biopsy for prostate-cancer diagnosis (PRECISION trial). N Engl J Med. 2018;378(19):1767--1777.
\end{enumerate}
