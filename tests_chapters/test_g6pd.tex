...
\begin{itemize}
  ...
  \item Newborn screening in jurisdictions where G6PD deficiency is common
\end{itemize}
...
G6PD Mediterranean variant. Profound deficiency, severe acute hemolytic anemia after exposure to fava beans (favism), infections, or drugs. Can be life-threatening. Neonatal jaundice (severe hyperbilirubinemia and kernicterus risk).
...
\section*{References}
\begin{enumerate}
  \item Luzzatto L, Ally M, Notaro R. Glucose-6-phosphate dehydrogenase deficiency. Blood. 2020;136(11):1225--1240.
  \item Beutler E. G6PD deficiency. Blood. 1994;84(11):3613--3636.
  \item Cappellini MD, Fiorelli G. Glucose-6-phosphate dehydrogenase deficiency. Lancet. 2008;371(9606):64--74.
  \item Carson PE, Flanagan CL, Ickes CE, Alving AS. Enzymatic deficiency in primaquine-sensitive erythrocytes. Science. 1956;124(3220):484--485.
  \item Beutler E, Mitchell M. Special modifications of the fluorescent screening method for glucose-6-phosphate dehydrogenase deficiency. Blood. 1968;32(5):816--818.
  \item WHO Working Group. Glucose-6-phosphate dehydrogenase deficiency. Bull World Health Organ. 1989;67(6):601--611.
  \item Ruwende C, Hill A. Glucose-6-phosphate dehydrogenase deficiency and malaria. J Mol Med. 1998;76(8):581--588.
\end{enumerate}
\clearpage
