...
Lipoprotein(a); Lp(a); LpA; Apolipoprotein(a)
...
Assays vary in calibration; results may differ across laboratories. Same patient should be measured with the same assay if monitoring therapy. Apo(a) size heterogeneity can bias results: small isoforms under-read, large isoforms over-read depending on assay.
...
\begin{itemize}
  ...
  \item \textbf{Elevated (EAS, ACC/AHA):} $>$ 50 mg/dL ($>$ 125 nmol/L) confers 2--3-fold cardiovascular risk
...
\section*{References}
\begin{enumerate}
  \item Kronenberg F, Utermann G. Lipoprotein(a): causal risk factor for atherosclerotic disease. Curr Atheroscler Rep. 2023;25(4):225-237.
  \item Mach F, et al. ESC/EAS guidelines for the management of dyslipidaemias. Eur Heart J. 2020;41(1):111-188.
  \item Wilson DP, et al. Use of Lipoprotein(a) in clinical practice: A National Lipid Association Scientific Statement. J Clin Lipidol. 2019;13(5):737-747.
  \item Viney NJ, et al. Antisense oligonucleotide targeting apolipoprotein(a) lowers Lp(a). Lancet. 2016;388(10057):2239-2253.
\end{enumerate}
