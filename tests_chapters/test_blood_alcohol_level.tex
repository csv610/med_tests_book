...
\section*{References}
\begin{enumerate}
  \item Jones AW. Evidence-based survey of the elimination rates of ethanol from blood with applications in forensic casework. Forensic Sci Int. 2010;200(1--3):1--20.
  \item Vonghia L, Leggio L, Ferrulli A, et al. Acute alcohol intoxication. Eur J Intern Med. 2008;19(8):561--567.
  \item Widmark EMP. Die theoretischen Grundlagen und die praktische Verwendbarkeit der gerichtlich-medizinischen Alkoholbestimmung. Berlin: Urban \& Schwarzenberg; 1932.
  \item Borkenstein RF, Crowther RF, Shumate RP, Ziel WB, Zylman R. The role of the drinking driver in traffic accidents (the Grand Rapids study). Blutalkohol. 1974;11(Suppl 1):1--131.
  \item Jones AW. Alcohol: its absorption, distribution, metabolism, and excretion in the body and pharmacokinetic calculations. WIREs Forensic Sci. 2019;1(5):e1348.
\end{enumerate}
\clearpage
