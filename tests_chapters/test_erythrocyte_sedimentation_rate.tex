...
\begin{itemize}
  \item Diagnosis of giant cell (temporal) arteritis --- markedly elevated ESR (often >50 mm/hour, frequently >100 mm/hour) is a key diagnostic criterion, and the ESR is used to monitor response to high-dose corticosteroid therapy. A normal ESR makes temporal arteritis unlikely but does not exclude it.
  \item Diagnosis of polymyalgia rheumatica --- ESR is frequently >40 mm/hour and is a diagnostic criterion; used to monitor disease activity and response to corticosteroid therapy
...
\begin{itemize}
  ...
  \item \textbf{Rheumatoid arthritis:} ESR correlates with disease activity and is used with joint counts, patient global assessment, and CRP to calculate disease activity scores (DAS28-ESR). Guiding therapy to achieve clinical remission often involves normalizing or substantially reducing the ESR.
...
\begin{itemize}
  ...
  \item \textbf{Note:} The ESR increases with age in healthy individuals, and age-adjusted normal values should be used for older patients.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Salvarani C, Cantini F, Hunder GG. Polymyalgia rheumatica and giant-cell arteritis. Lancet. 2008;372(9634):234--245.
  \item Kermani TA, Warrington KJ. Polymyalgia rheumatica. Lancet. 2013;381(9860):63--72.
  \item Sokka T, Pincus T. Erythrocyte sedimentation rate, C-reactive protein, or rheumatoid factor are normal at presentation in 35\%--45\% of patients with rheumatoid arthritis seen between 1980 and 2004. Clin Exp Rheumatol. 2009;27(1):80--84.
  \item Brigden ML. Clinical utility of the erythrocyte sedimentation rate. Am Fam Physician. 1999;60(5):1443--1450.
  \item ICSH. ICSH recommendations for measurement of erythrocyte sedimentation rate. J Clin Pathol. 2011;64(2):120--125.
\end{enumerate}
