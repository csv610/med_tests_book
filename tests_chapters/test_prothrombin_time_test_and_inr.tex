...
\begin{itemize}
  \item \textbf{Prothrombin Time (seconds):} 11.0--13.5 seconds (reagent-dependent; each laboratory establishes its own range for its specific thromboplastin reagent)
...
\begin{enumerate}
  ...
  \item Quick AJ. The prothrombin in hemophilia and in obstructive jaundice. J Biol Chem. 1935;109:73--74.
  \item Kirkwood TBL. Calibration of reference thromboplastins and standardisation of the prothrombin time ratio. Thromb Haemost. 1983;49(3):238--244.
  \item Tripodi A, Chantarangkul V, Mannucci PM. The International Normalized Ratio: calibrated to an individual laboratory's mean normal prothrombin time provides optimal performance. J Thromb Haemost. 2008;6(5):882--884.
  \item Kitchen S, Adcock DM, Dauer R, et al. International Council for Standardization in Haematology (ICSH) recommendations for processing of blood samples for coagulation testing. Int J Lab Hematol. 2021;43(6):1273--1284.
\end{enumerate}
