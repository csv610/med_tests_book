...
Epithelial cells in urine are exfoliated cells from the urinary tract lining. Squamous epithelial cells originate from the distal urethra and external genitalia. Transitional (urothelial) cells come from the renal pelvis, ureters, bladder, and proximal urethra. Renal tubular cells come from the nephron. The clinical significance depends on cell type and quantity. Squamous cells are usually a contaminant from improper collection. Transitional and especially renal tubular cells can signal pathology. Epithelial cell enumeration is part of the routine urine microscopic examination.

\section*{Alternative Names}
\begin{itemize}
  \item Urine Epithelial Cells
  \item Urinalysis Epithelial Cells
  \item Renal Tubular Cells
  \item Transitional Cells
  \item Squamous Cells (Urinary)
\end{itemize}
\section*{Principle}
...
\section*{History}
Microscopic urinary sediment examination has been performed since the 19th century. Modern automated image analyzers (IQ200, Atellica UAS800) classify cells using neural-network imaging; however, manual microscopy remains the reference standard.
...
\begin{itemize}
  \item Specimens $>$ 2 hours old at room temperature may show degenerated cells and increased bacteria. Refrigerated specimens can develop crystals that interfere with microscopy. Specimens contaminated with talc or lotion can show artifacts resembling cells.
\end{itemize}
\section*{Risks}
None.
