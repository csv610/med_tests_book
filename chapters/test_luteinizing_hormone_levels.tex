...
\begin{itemize}
  ...
  \item Serum LH
  \item Plasma LH
  \item Interstitial Cell-Stimulating Hormone (ICSH, historical)
  \item LH:FSH Ratio
  \item LH Surge
  \item Ovulation Predictor
\end{itemize}
\section*{Principle}
