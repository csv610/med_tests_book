...
\begin{itemize}
  \item False negatives: photo-oxidation (specimen sitting in light $>$ 1 hour), high-dose vitamin C, high urinary nitrite. False positives: phenazopyridine (Pyridium), indole, large doses of chlorpromazine metabolites, rifampin (also discolors urine). Specimen should be protected from light.
\end{itemize}
\section*{Risks}
None.
