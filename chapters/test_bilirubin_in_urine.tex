...
\begin{itemize}
  \item Urine Bilirubin
  \item Urinalysis Bilirubin
  \item Bilirubinuria
  \item Dipstick Bilirubin
\end{itemize}
\section*{Principle}
...
None. Hydration is normal. The patient should not take large-dose vitamin C prior.

\section*{Contraindications and Precautions}
\begin{itemize}
  \item False negatives: photo-oxidation (specimen sitting in light $>$ 1 hour), high-dose vitamin C, high urinary nitrite. False positives: phenazopyridine (Pyridium), indole, large doses of chlorpromazine metabolites, rifampin (also discolors urine). The specimen should be protected from light.
\end{itemize}
\section*{Risks}
None.
