...
Vitamin D is a fat-soluble secosteroid hormone. The skin produces it from 7-dehydrocholesterol upon exposure to ultraviolet B (UVB) radiation (wavelength 290--315 nm), and it is also obtained from the diet (fatty fish, fortified milk) and supplements. The biologically inactive form --- vitamin D3 (cholecalciferol, from skin and animal sources) and vitamin D2 (ergocalciferol, from plant sources and supplements) --- is hydroxylated in the liver by 25-hydroxylase (CYP2R1) to 25-hydroxy vitamin D (25(OH)D, calcidiol). This is the major circulating form and the best biomarker for vitamin D status. The kidney then hydroxylates 25(OH)D further by 1-alpha-hydroxylase (CYP27B1) to the biologically active form, 1,25-dihydroxy vitamin D (1,25(OH)2D, calcitriol). This active form acts through the vitamin D receptor (VDR) to regulate calcium and phosphate homeostasis (increased intestinal absorption, renal reabsorption, and bone resorption), bone mineralization, and immune function. Vitamin D deficiency causes rickets in children (bowed legs, rachitic rosary, craniotabes, delayed fontanelle closure) and osteomalacia in adults (bone pain, proximal muscle weakness, pathologic fractures). Deficiency is common: prevalence of 25(OH)D <20 ng/mL is approximately 30--40\% in the general U.S. population. It is higher in African Americans (due to melanin blocking UVB), obese individuals (sequestration in adipose tissue), institutionalized elderly, and patients with malabsorption.
\section*{Alternative Names}
\begin{itemize}
  \item 25-Hydroxy Vitamin D
  \item 25(OH)D
  \item Calcidiol
  \item Vitamin D3
  \item Cholecalciferol Level
  \item Vitamin D Status
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  \item To evaluate suspected vitamin D deficiency in patients with bone pain, proximal muscle weakness, or pathologic fractures
  \item To confirm rickets in children and osteomalacia in adults
  \item To assess secondary hyperparathyroidism, hypocalcemia, hypophosphatemia, and elevated alkaline phosphatase
  \item For screening of at-risk groups: institutionalized or housebound elderly, individuals with dark skin, obese patients, and patients with malabsorption (celiac disease, Crohn's disease, post-bariatric surgery)
  \item As part of the osteoporosis workup to document status before therapy and to guide supplementation
  \item To monitor 25(OH)D levels after 3 months of replacement therapy to confirm adequate repletion
\end{itemize}
...
\begin{itemize}
  \item No contraindications to standard venipuncture. Interpretive cautions:
  \item (1) 25(OH)D is the correct test for nutritional status, and 1,25(OH)2D should not be used for this purpose because it is tightly regulated and may be normal or even elevated despite deficiency;
  \item (2) assay methods vary, and LC-MS/MS is the reference method, with immunoassays able to over- or underestimate values;
  \item (3) severe obesity lowers measured 25(OH)D due to adipose sequestration without necessarily indicating tissue deficiency; and
  \item (4) target ranges differ between the Institute of Medicine (adequate $>$20 ng/mL) and Endocrine Society (30--100 ng/mL) guidelines.
\end{itemize}
\section*{Risks}
