...
\begin{itemize}
  \item Hydrogen breath test for lactose
  \item Lactose breath test
  \item Oral lactose tolerance test
\end{itemize}
...
\begin{itemize}
  \item \textbf{Hydrogen Breath Test:} You fast for 12 hours. You provide a baseline breath sample, drink a lactose solution, and then blow into a breath analyzer at 15- to 30-minute intervals for 2 to 3 hours \cite{hammer2022european}.
  \item \textbf{Blood Test:} Serial blood samples are drawn at baseline, 30, 60, and 120 minutes after drinking the lactose solution.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Breath Test:} A normal (negative) result. An increase of less than 20 ppm of hydrogen over baseline indicates normal lactose digestion.
  \item \textbf{Blood Test:} An abnormal result. A blood glucose rise of less than 20 mg/dL over baseline indicates lactase deficiency.
\end{itemize}

\subsection*{Above Normal}
\begin{itemize}
  \item \textbf{Breath Test:} An abnormal (positive) result. An increase of 20 ppm or more of hydrogen over baseline indicates lactose malabsorption.
  \item \textbf{Blood Test:} A normal result. A rise of 20 mg/dL or more of blood glucose indicates normal digestion.
\end{itemize}

\section*{Normal Results}
\begin{itemize}
  \item Breath hydrogen rise < 20 ppm above baseline.
  \item Blood glucose rise $\geq$ 20 mg/dL above baseline.
\end{itemize}
