...
\begin{itemize}
  ...
  \item Evaluation of hyperandrogenism in women with hirsutism, severe inflammatory acne, androgenic alopecia, oligomenorrhea/amenorrhea, or virilization (clitoromegaly, deepening voice, temporal hair recession) --- elevated total or free testosterone supports PCOS or an androgen-secreting tumor
...
\end{itemize}
\section*{Risks}
Minimal risk. Slight pain, bruising, or hematoma at the venipuncture site. Rarely: vasovagal syncope. No radiation exposure.
...
\begin{itemize}
  ...
  \item 5-alpha-reductase deficiency (46,XY): normal testosterone but low DHT. Ambiguous genitalia at birth, virilization at puberty. Diagnosis by an elevated testosterone-to-DHT ratio.
\end{itemize}
...
\begin{itemize}
  ...
  \item Androgen-secreting ovarian tumors: Sertoli-Leydig cell tumors, hilus cell tumors, and lipid cell tumors. Rapid onset virilization, testosterone >150--200 ng/dL (often >200 ng/dL). Pelvic ultrasound or MRI detects an ovarian mass. LH/FSH suppressed.
  \item Androgen-secreting adrenal tumors: adrenal adenoma or carcinoma. Testosterone and DHEA-S elevated. Adrenal CT shows an adrenal mass. Typically testosterone >200 ng/dL with DHEA-S >700 mcg/dL.
...
\begin{itemize}
  ...
  \item DHEA-S: Distinguish adrenal from ovarian hyperandrogenism in women. Elevated DHEA-S suggests an adrenal source.
  ...
  \item DHT (dihydrotestosterone): Evaluate 5-alpha-reductase activity. A testosterone-to-DHT ratio >20:1 suggests 5-alpha-reductase deficiency.
  ...
  \item Semen analysis: In male infertility with abnormal testosterone/LH/FSH. Azoospermia with elevated FSH suggests a non-obstructive etiology.
