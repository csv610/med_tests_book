...
Alpha-fetoprotein (AFP) is a glycoprotein produced by the fetal yolk sac and liver. After birth, AFP levels fall rapidly, reaching adult levels by 1 year. In adults, AFP is measured as a serum tumor marker for hepatocellular carcinoma (HCC) and germ cell tumors. It is also measured as a maternal serum marker for pregnancy screening. This chapter focuses on serum AFP as a tumor marker. Maternal serum AFP for pregnancy screening is also discussed briefly. In oncology, AFP is most useful in monitoring known HCC treated with resection or ablation. In many patients, rising AFP precedes imaging evidence of recurrence. AFP should be interpreted with imaging, not alone, because 20\% of HCCs are AFP-negative.

\section*{Alternative Names}
\begin{itemize}
  \item AFP
  \item Alpha-Fetoprotein
  \item Alpha-1-Fetoprotein
  \item $\alpha$FP
\end{itemize}
\section*{Principle}
...
This is a secondary test. AFP is used to monitor suspected or confirmed disease rather than to screen asymptomatic low-risk individuals. Surveillance in high-risk patients with cirrhosis combines ultrasound and AFP.

\section*{How This Test Is Performed}
A venous blood sample is drawn into a serum separator tube (gold-top or tiger-top). One mL of serum suffices. For pregnancy screening, maternal serum is drawn between 15 and 22 weeks gestation (optimal 16--18 weeks). It is interpreted with ultrasound dating, gestational age, maternal weight, race, and diabetes status.
...
\begin{itemize}
  \item False-positive AFP elevations occur in pregnancy with incorrect dating, multiple gestation, fetal demise, miscarriage, and open fetal defects. In non-pregnant adults, they occur due to chronic hepatitis, cirrhosis, and hepatic regeneration. AFP-L3 improves specificity when chronic liver disease is present. Anti-recombinant mouse antibodies and heterophilic antibodies can cause spurious results.
\end{itemize}
\section*{Risks}
