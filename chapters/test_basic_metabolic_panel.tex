...
\begin{itemize}
  \item No absolute contraindications. Fasting affects glucose. Dehydration raises BUN, creatinine, and electrolytes. Specimen hemolysis falsely raises potassium.
\end{itemize}
\section*{Risks}
