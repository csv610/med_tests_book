...
\begin{itemize}
  \item ALP
  \item Alk Phos
  \item Serum Alkaline Phosphatase
  \item Alkaline Phosphatase Isoenzymes
  \item Bone-Specific Alkaline Phosphatase (BSAP)
  \item Liver Alkaline Phosphatase
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  ...
  \item (1) Zinc and magnesium chelators (EDTA, citrate, oxalate) in collection tubes falsely low ALP because these metals are required cofactors. Only serum or heparin tubes should be used.
  \item (2) ALP is elevated in normal growth---children and adolescents have higher ALP than adults; reference ranges for pediatric patients are age-specific.
  \item (3) Benign transient hyperphosphatasemia of infancy/childhood: striking elevation of ALP (3--20$\times$ ULN) without liver or bone disease, resolving spontaneously within weeks to months. Usually due to increased sialylation of ALP reducing hepatic clearance. ALP isoenzymes show bone and liver fractions. No treatment needed beyond reassurance.
  \item (4) ALP rises during third trimester of pregnancy from placental isoenzyme (1.5--3$\times$ ULN in 30--40\% of pregnancies).
  \item (5) Blood group B or O individuals (secretors) have higher intestinal ALP after meals; fasting sample avoids this.
  \item (6) Macro-ALP: rare complex of ALP with immunoglobulins causing persistently elevated ALP; differentiated by PEG precipitation \cite{wallach2022interpretation}.
\end{itemize}
\section*{Risks}
Minimal risk from venipuncture. Mild pain or bruising at site resolves in 1--2 days.

\section*{What Happens After the Test}
Results available within 30--60 minutes. When ALP is elevated, determine hepatobiliary vs. bone origin: (1) Check GGT: if GGT elevated, ALP is hepatobiliary (cholestasis). (2) If GGT normal, ALP is likely bone (Paget disease, fractures, bone metastases, osteomalacia, growing child) or placental. (3) If both ALP and GGT are elevated but AST/ALT are disproportionately high, this may indicate a mixed hepatocellular-cholestatic pattern. Biliary obstruction typically causes ALP >3--5$\times$ ULN with GGT >3$\times$ ULN and minimal AST/ALT elevation (or only mild elevation). Infiltrative liver disease (metastases, granulomas) can produce isolated or disproportionate ALP elevation.
