...
\begin{itemize}
  ...
  \item Differentiation of vitamin B12 deficiency from folate deficiency when combined with serum methylmalonic acid (both are high in B12 deficiency; only homocysteine is high in isolated folate deficiency) \cite{stabler1990clinical}
...
A fasting blood sample is collected by venipuncture into an EDTA (lavender-top) tube and placed immediately on ice. Plasma must be separated from cells within 30--60 minutes, because homocysteine leaks from erythrocytes at room temperature, producing falsely high results. Total homocysteine (free, protein-bound, and disulfide forms) is measured by immunoassay, HPLC with fluorescence detection, or LC-MS/MS (reference method). Results are available within hours to days depending on the laboratory.
...
\begin{itemize}
  \item There are no absolute contraindications. Specimen-handling precautions are critical: delays in centrifugation longer than 30--60 minutes cause spuriously high homocysteine. Interpretive cautions:
  \item (1) renal insufficiency raises homocysteine independent of vitamin status;
  \item (2) MTHFR C677T homozygosity raises homocysteine only when folate intake is low;
