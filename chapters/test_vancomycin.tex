...
The vancomycin level measures the serum concentration of vancomycin. Vancomycin is a glycopeptide antibiotic used to treat serious Gram-positive bacterial infections, particularly methicillin-resistant Staphylococcus aureus (MRSA), coagulase-negative staphylococci, and ampicillin-resistant enterococci. Vancomycin inhibits bacterial cell wall synthesis by binding to the D-Ala-D-Ala terminus of the peptidoglycan pentapeptide precursor. This prevents cross-linking of peptidoglycan chains and results in bacterial cell death. Vancomycin is administered intravenously, except for oral vancomycin for Clostridioides difficile colitis, which is not systemically absorbed.
...
\begin{itemize}
  \item Vancomycin Level
  \item Vancomycin Trough
  \item Vancomycin Serum Concentration
  \item Vanc Level
  \item Vanc TDM
\end{itemize}
\section*{Principle}
