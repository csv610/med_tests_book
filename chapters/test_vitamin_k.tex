...
Phylloquinone (Vitamin K1); Menaquinone (Vitamin K2); Serum Vitamin K; Vitamin K Status; Prothrombin Time (functional measure)
...
There are no absolute contraindications to standard venipuncture. Important interpretive cautions: (1) Plasma phylloquinone reflects recent intake and is not a direct measure of hepatic stores; a normal level does not exclude tissue-level deficiency in the presence of impaired gamma-carboxylation. (2) Levels fluctuate with diet, so a single fasting sample is the standard, and low-fat diets lower measured values. (3) Cholestasis and malabsorption lower vitamin K despite normal intake. (4) The PT/INR is the functional test of choice: it is prolonged in deficiency and corrects within 24 hours of parenteral vitamin K. (5) PIVKA-II (des-gamma-carboxy prothrombin) is a sensitive marker of subclinical deficiency and of hepatocellular carcinoma. (6) Specimens exposed to light or left unprocessed degrade rapidly. (7) In newborns, plasma phylloquinone is low even in health, so reference ranges must be age-specific; the diagnosis of hemorrhagic disease of the newborn is primarily clinical and based on the PT response to vitamin K.
