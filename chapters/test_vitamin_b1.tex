...
\begin{itemize}
  ...
  \item TPP
  \item erythrocyte transketolase activity
\end{itemize}
\section*{Principle}
Testing may measure whole-blood thiamine or thiamine diphosphate, usually by high-performance liquid chromatography or liquid chromatography--mass spectrometry. Erythrocyte transketolase activity, with or without added TPP, is an older functional method. It is less commonly used.
...
Thiamine testing is a supportive test. Suspected Wernicke encephalopathy is a clinical emergency. Treatment should not be delayed while waiting for the result.
