...
This test detects antibodies to the bacterium \textit{Borrelia burgdorferi}, the cause of Lyme disease. It uses a standardized two-tier testing protocol recommended by public health guidelines to ensure high diagnostic specificity \cite{cdc2023lyme}.

\section*{Alternative Names}
\begin{itemize}
  \item Lyme serology
  \item Borrelia burgdorferi antibody test
  \item Lyme ELISA
  \item Lyme immunoblot (Western blot)
  \item Two-tier Lyme test
\end{itemize}
...
The test is ordered when a patient has symptoms of Lyme disease, such as an erythema migrans (bulls-eye) rash, joint pain, facial palsy, meningitis, or chronic fatigue, especially if there is a history of tick exposure in endemic regions.

\section*{Primary vs Secondary Test}
This is a primary screening and confirmatory diagnostic test for Lyme disease.

\section*{How This Test Is Performed}
A healthcare professional draws a sample of blood from a vein in the arm.
...
\end{itemize}
\section*{Risks}
There is minimal risk associated with a blood draw. Minor bruising or discomfort may occur at the puncture site.

\section*{What Happens After the Test}
Results are typically available in 3 to 7 days. If the two-tier test is positive and the patient has active symptoms, the doctor will prescribe a course of antibiotics (typically doxycycline or amoxicillin).

\section*{Understanding Results}

\subsection*{Below Normal}
A negative result (no antibodies detected) indicates that the patient likely does not have Lyme disease. However, early in the infection (the first 2 to 4 weeks), antibodies may not yet have reached detectable levels (the window period).
