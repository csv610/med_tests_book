...
Serum ferritin measures the concentration of ferritin, the main intracellular iron storage protein, in the blood. Ferritin is a 450-kDa spherical protein made of 24 subunits (a heavy H-chain with ferroxidase activity and a light L-chain). These subunits form a hollow shell that can store up to 4,500 iron atoms as a ferric oxyhydroxide-phosphate mineral core. Serum ferritin stays in balance with intracellular ferritin stores. So 1 mcg/L of serum ferritin corresponds to about 8--10 mg of stored body iron. It is the single most useful laboratory test for assessing total body iron stores \cite{camaschella2015iron}. Ferritin falls in iron deficiency (the earliest and most specific indicator) and rises in iron overload (hemochromatosis, transfusional siderosis). However, ferritin is also an acute phase reactant. The liver and reticuloendothelial macrophages synthesize it in response to inflammation, infection, malignancy, and liver disease. Ferritin is markedly elevated in hemophagocytic lymphohistiocytosis (HLH, >500 ng/mL, often >3,000--10,000+ ng/mL), Still disease (adult-onset Still disease, >1,000 ng/mL with marked hyperferritinemia), and COVID-19-associated hyperinflammatory syndrome. In these conditions, ferritin reflects macrophage activation and systemic inflammation, not iron overload.
...
\end{itemize}
\section*{Principle}
Ferritin is measured by a two-site sandwich chemiluminescent immunoassay (CLIA) or electrochemiluminescent immunoassay (ECLIA) using anti-ferritin monoclonal or polyclonal antibodies. The detection antibody is conjugated to a chemiluminescent label.
\section*{History}
Ferritin was first isolated from horse spleen in 1937 by Vaclav Laufberger, who gave the iron-rich protein its name from the Latin ``ferrum'' (iron). In the 1940s, Michaelis, Coryell, and Granick characterized its structure and iron core. They established that ferritin is a protein shell surrounding a ferric oxide--phosphate mineral. The first immunoassays for serum ferritin were developed in the early 1970s \cite{addison1972immunoradiometric}. The landmark 1975 paper by Jacobs and Worwood showed that serum ferritin quantitatively reflects total body iron stores. This made it the cornerstone of iron status assessment \cite{jacobs1975ferritin}. Automated chemiluminescent immunoassays progressively replaced radioimmunoassays in the 1990s and 2000s. These remain the standard platforms today. Recognition of ferritin as an acute phase reactant and of marked hyperferritinemia in hemophagocytic syndromes evolved over the 1990s--2010s. This expanded its clinical interpretation beyond iron overload.
...
Ferritin is a primary, first-line test for assessing total body iron stores and is the most sensitive and specific single marker of iron deficiency. It is always interpreted together with the CBC, serum iron, TIBC, and transferrin saturation. When inflammation confounds ferritin, the soluble transferrin receptor or bone marrow iron staining (the gold standard) is used instead.
...
\begin{itemize}
  ...
  \item (1) Ferritin is an acute phase reactant, so concurrent inflammation, infection, malignancy, and liver disease raise it and can mask true iron deficiency; in such patients a ferritin below 30 ng/mL, or below 100 ng/mL in chronic kidney disease, still strongly suggests depleted stores.
...
The ferritin result is interpreted alongside the CBC, serum iron, TIBC, transferrin saturation, and inflammatory markers. A low ferritin confirms iron deficiency and prompts iron replacement plus investigation of the underlying cause (gastrointestinal blood loss, malabsorption, or inadequate intake) \cite{guyatt1992laboratory}. An elevated ferritin with elevated transferrin saturation triggers evaluation for iron overload, including HFE gene testing and consideration of phlebotomy. An elevated ferritin with normal transferrin saturation instead suggests an inflammatory or hepatic cause.
