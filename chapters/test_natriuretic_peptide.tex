...
\begin{itemize}
  \item B-Type Natriuretic Peptide
  \item BNP
  \item Brain Natriuretic Peptide (historical name, never produced in brain)
  \item NT-proBNP (N-Terminal pro-B-Type Natriuretic Peptide)
  \item Serum BNP
  \item Plasma BNP
  \item Natriuretic Peptide Type B
  \item ProBNP
  \item NT-proBNP by Immunoassay
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  \item Factors that elevate BNP/NT-proBNP independent of heart failure:
  \item (1) Age: BNP and NT-proBNP increase progressively with age (age-stratified cutoffs are essential for NT-proBNP);
  \item (2) Female sex: baseline BNP/NT-proBNP is 10--20\% higher in women than men (estrogen effects);
  \item (3) Chronic kidney disease (CKD): both BNP and NT-proBNP are elevated because of decreased renal clearance; NT-proBNP is more dependent on renal clearance and is more affected by CKD than BNP;
  \item (4) Atrial fibrillation: atrial stretch and myocyte stress elevate BNP/NT-proBNP independently of ventricular dysfunction;
  \item (5) Acute coronary syndromes: myocardial ischemia causes transient BNP elevation even without heart failure;
  \item (6) Right ventricular dysfunction and pulmonary hypertension (including pulmonary embolism);
  \item (7) Sepsis, systemic inflammatory response syndrome (SIRS), and critical illness;
  \item (8) Hyperthyroidism;
  \item (9) Cirrhosis with ascites;
  \item (10) Anemia;
  \item (11) Subarachnoid hemorrhage and stroke;
  \item (12) High cardiac output states (pregnancy, hyperthyroidism). Factors that lower BNP/NT-proBNP:
  \item (1) Obesity --- BMI inversely correlated with BNP/NT-proBNP, possibly due to increased NPR-C clearance receptors on adipocytes; obese patients with heart failure may have "falsely low" BNP levels. Lower BNP cutoffs should be used in obesity (BNP <50 pg/mL to exclude heart failure if BMI >35).
  \item (2) Pericardial constriction and restrictive cardiomyopathy may have relatively low BNP compared to degree of heart failure because the pericardium or infiltrated myocardium limits wall stretch, which is the stimulus for BNP production.
  \item (3) Flash pulmonary edema: BNP may not have time to rise because symptom onset is rapid (<1--2 hours).
  \item (4) Sacubitril/valsartan therapy: increases BNP (neprilysin inhibition decreases BNP degradation) but decreases NT-proBNP (reduced wall stress from improved heart function). Always interpret BNP with knowledge of the patient's medications. NT-proBNP is preferred in patients on Entresto. Hemolysis can interfere with BNP assays.
\end{itemize}
\section*{Risks}
