...
\section*{History}
Weinstein and colleagues at Schering Corporation discovered gentamicin in 1963 from the soil actinomycete Micromonospora purpurea. It became available in the United States in 1969. The introduction of once-daily dosing regimens in the 1990s was based on recognition of two key pharmacodynamic concepts: concentration-dependent killing (higher peak/MIC ratio increases bacterial killing) and the post-antibiotic effect (suppression of bacterial growth that persists after antibiotic concentrations fall below the MIC) \cite{freeman1997once}. The Hartford nomogram for extended-interval dosing was developed in 1999 \cite{nicolau1995experience}.
