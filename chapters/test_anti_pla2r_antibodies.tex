...
Anti-phospholipase A2 receptor antibodies are autoantibodies linked to primary membranous nephropathy, a kidney disease that commonly presents with significant proteinuria or nephrotic syndrome.

\section*{Alternative Names}
\begin{itemize}
  \item Anti-PLA2R
  \item PLA2R Antibody
  \item Phospholipase A2 Receptor Antibody
\end{itemize}
...
A positive result supports primary membranous nephropathy in the correct clinical context. Higher or persistent levels may be linked to active disease, while falling or negative levels can accompany immunologic remission; urine protein and kidney function remain essential for monitoring.
