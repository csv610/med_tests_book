...
PCR is highly sensitive, but it may detect colonization rather than active pneumonia, especially in upper-airway specimens. A positive result must be interpreted with symptoms, oxygenation, imaging, microscopic staining or immunofluorescence when available, and beta-D-glucan. A negative result lowers the likelihood of PJP but does not exclude disease if the specimen is poor or the fungal burden is low.
...
The report should state the specimen type, qualitative result, and quantitative value or assay cutoff when available. PCR can detect colonization as well as disease, particularly in upper-airway samples, so a positive result is not sufficient by itself. Follow-up combines symptoms, oxygenation, respiratory findings, microscopy or staining when available, beta-D-glucan, and other diagnoses; a negative result may need reconsideration if the specimen is inadequate.
