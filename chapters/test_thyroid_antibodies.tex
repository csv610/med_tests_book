...
\begin{itemize}
  \item Anti-Thyroid Peroxidase Antibodies (Anti-TPO, TPOAb)
  \item Anti-Thyroglobulin Antibodies (Anti-Tg, TgAb)
  \item TSH Receptor Antibodies (TRAb)
  \item Thyroid-Stimulating Immunoglobulin (TSI)
  \item TSH-Binding Inhibitory Immunoglobulin (TBII)
  \item Anti-Microsomal Antibodies (historical term for anti-TPO)
  \item Thyroid Autoantibody Panel
\end{itemize}
\section*{Principle}
