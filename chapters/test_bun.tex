...
\begin{itemize}
  ...
  \item Assessment of prerenal azotemia in dehydrated patients: a BUN:Cr ratio >20:1 suggests a prerenal cause (dehydration, heart failure, shock, GI bleeding, high protein intake, corticosteroid use, tetracycline)
  \item Evaluation of gastrointestinal bleeding: blood in the GI tract is digested by gut bacteria, and the resulting amino acids are absorbed and converted to urea. This causes a disproportionate rise in BUN (BUN:Cr >30:1, even >36:1) with normal creatinine. This is a classic clinical clue for upper GI bleeding
...
\begin{itemize}
  ...
  \item \textbf{Pregnancy:} Physiological expansion of plasma volume and increased GFR cause dilution and increased renal urea clearance. BUN is typically 5--10 mg/dL in the second and third trimesters.
...
\begin{itemize}
  ...
  \item \textbf{Upper endoscopy:} If GI bleeding is suspected based on the BUN:Cr ratio.
