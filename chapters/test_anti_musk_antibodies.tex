...
MuSK antibodies target muscle-specific kinase, a protein involved in communication between nerves and skeletal muscle. They are linked to a subgroup of autoimmune myasthenia gravis, particularly when acetylcholine-receptor antibodies are absent.

\section*{Alternative Names}
\begin{itemize}
  \item Anti-MuSK
  \item Muscle-Specific Kinase Antibody
  \item MuSK Autoantibody
\end{itemize}
