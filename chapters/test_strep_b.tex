...
\begin{itemize}
  \item GBS Culture
  \item Group B Strep Screen
  \item GBS Screening
  \item Vaginal-Rectal GBS Culture
  \item GBS PCR
  \item Intrapartum GBS NAAT
  \item \textit{Streptococcus agalactiae} Culture
  \item GBS Latex Agglutination
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  ...
  \item \textbf{Neonatal CSF culture and CSF PCR:} For all neonates with suspected GBS sepsis; lumbar puncture is indicated for all infants with positive blood cultures because meningitis may be present without clinical signs
