...
\begin{itemize}
  ...
  \item Required screening prior to initiation of biologic immunosuppressive agents (infliximab, adalimumab, etanercept) that are linked to reactivation of latent TB
\end{itemize}
