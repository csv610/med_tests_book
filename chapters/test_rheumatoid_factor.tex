...
Rheumatoid factor (RF) is an autoantibody, most commonly of the IgM isotype, directed against the Fc portion of IgG. RF was the first autoantibody discovered in rheumatoid arthritis and has been used as a diagnostic and prognostic marker for RA since the 1940s. B cells in the synovium, lymph nodes, and bone marrow produce RF in response to immune complex formation. RF may play a role in the pathogenesis of RA by forming immune complexes that activate complement and recruit inflammatory cells \cite{smolen2016rheumatoid}. RF testing is performed using latex agglutination, nephelometry, or enzyme-linked immunosorbent assay (ELISA). RF is not specific for RA --- it is found in other autoimmune diseases (Sjogren syndrome, systemic lupus erythematosus), chronic infections (hepatitis C, subacute bacterial endocarditis, tuberculosis), and elderly individuals without disease.

\section*{Alternative Names}
\begin{itemize}
  \item RF
  \item Rheumatoid Factor
  \item Rheumatoid Arthritis Factor
  \item RA Factor
  \item RhF
  \item Latex Fixation Test
  \item RA Latex
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  ...
  \item Evaluation of suspected Sjogren syndrome in patients with sicca symptoms and raised RF
...
This is a primary screening test for rheumatoid arthritis, used together with anti-CCP antibody testing. Positive RF supports the diagnosis of RA but must be interpreted with the full clinical picture, as RF has limited specificity.
...
\begin{itemize}
  ...
  \item Osteoarthritis, gout, and calcium pyrophosphate deposition disease (pseudogout) are linked to negative RF
...
\begin{itemize}
  ...
  \item Sjogren syndrome: RF is positive in 60--90\% of patients with primary Sjogren syndrome. RF positivity in a patient with sicca symptoms, raised anti-SSA/Ro, and anti-SSB/La supports the diagnosis
