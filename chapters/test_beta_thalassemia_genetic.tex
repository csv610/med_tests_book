...
\begin{itemize}
  \item HBB Gene Testing
  \item Beta-Globin Gene Sequencing
  \item Beta-Thalassemia Molecular Test
\end{itemize}
...
No fasting is required. Risks are limited to blood collection. A negative targeted panel may miss rare variants. A genetic result should be interpreted by a laboratory professional or genetic counselor rather than used alone to predict severity.
