...
A 24-hour urine collection in a dark container with 5 g sodium carbonate preservative protects from light; whole blood in EDTA; random fecal sample in an opaque container. Specimens must be protected from light during collection and transport. Samples for PBG/ALA must be refrigerated and assayed within 48 hours.
...
\begin{itemize}
  \item Light exposure denatures porphyrins: samples must be protected. False elevations from lead exposure, iron deficiency, liver disease, alcoholism, certain drugs. Differentiation of porphyrias requires fractionated porphyrins, not just a total porphyrin measurement.
\end{itemize}
\section*{Risks}
Venipuncture only.

\section*{What Happens After the Test}
Elevated urine PBG/ALA confirms acute porphyria \cite{anderson2005recommendations}. Subsequent fractionation in urine, feces, blood, plasma distinguishes acute intermittent porphyria, hereditary coproporphyria, variegate porphyria, porphyria cutanea tarda, erythropoietic protoporphyria, etc. Genetic testing confirms the specific gene defect.
...
\begin{itemize}
  \item \textbf{Porphyrin fractionation (urine, feces, plasma):} Confirms the subtype
  \item \textbf{Enzyme activity (e.g., PBG deaminase in RBCs):} Confirms AIP in some cases
  \item \textbf{Genetic testing (HMRS, CPOX, PPOX, UROD, FECH genes)}: Provides the definitive subtype and enables cascade family testing
  ...
  \item \textbf{Avoid porphyrinogenic drugs}: Barbiturates, sulfonamides, rifampin, oral contraceptives; consult safe drug lists at porphyriafoundation.org \cite{americanporphyria}
\end{itemize}
