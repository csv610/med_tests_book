...
\begin{itemize}
  \item Low sensitivity (15--30\% false negatives) limits utility: many patients with invasive bacterial diarrhea have few leukocytes in stool; fecal leukocytes falsely low in treated or resolving colitis. Specimen degradation over 2 hours; sample preservation crucial.
\end{itemize}
\section*{Risks}
