...
\begin{itemize}
  \item Fecal Chymotrypsin
  \item Stool Chymotrypsin
  \item Stool Chymotrypsin Activity
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  \item False-low results: prolonged intestinal transit, antibiotic therapy suppressing proteolytic bacteria that activate the proenzyme, acid-suppressing medications, ileus. False-high: porcine PERT enzymes cross-react. Aspirin and barium interfere with the colorimetric assay.
\end{itemize}
\section*{Risks}
