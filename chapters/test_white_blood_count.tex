...
The white blood cell (WBC) count, also called the leukocyte count, measures the total number of white blood cells (leukocytes) per unit volume of whole blood. White blood cells are the cellular mediators of the immune system. They defend the body against infection, inflammation, and foreign substances. Five major types of leukocytes circulate in the peripheral blood. Neutrophils phagocytose bacteria and fungi. Lymphocytes mediate adaptive immunity through B cells, T cells, and natural killer cells. Monocytes differentiate into tissue macrophages and dendritic cells. Eosinophils combat parasitic infections and take part in allergic responses. Basophils release histamine and heparin in inflammatory and allergic reactions. The total WBC count is a core component of the complete blood count. It is used as a screening test for infection, inflammation, bone marrow function, and hematologic malignancy. An elevated WBC count (leukocytosis) most commonly reflects an appropriate response to infection or inflammation, but may also indicate leukemia or other myeloproliferative disorders. A decreased WBC count (leukopenia) suggests bone marrow suppression, overwhelming infection, autoimmune disease, or drug effect. The WBC count must always be interpreted together with the differential count, which gives the percentage and absolute number of each leukocyte type.
...
The WBC count is a primary screening test and core component of the complete blood count. It is used for the detection and monitoring of infection, inflammation, hematologic malignancy, and bone marrow function.
...
\begin{itemize}
  ...
  \item \textbf{Autoimmune neutropenia:} Isolated neutropenia from anti-neutrophil antibodies, may be primary or linked to systemic lupus erythematosus, rheumatoid arthritis (Felty syndrome), or Sj\"{o}gren syndrome.
