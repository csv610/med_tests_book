...
The anti-cyclic citrullinated peptide (anti-CCP) antibody test detects autoantibodies directed against citrullinated proteins. Citrullination is a post-translational modification. The amino acid arginine is converted to citrulline by the enzyme peptidylarginine deiminase (PAD). In rheumatoid arthritis, aberrant citrullination of synovial proteins occurs. These proteins include filaggrin, vimentin, fibrinogen, and type II collagen. This generates neoepitopes that trigger an immune response. Anti-CCP antibodies are produced as a result. These antibodies are highly specific for rheumatoid arthritis (specificity 95--98\%). They can be detected years before the onset of clinical symptoms \cite{vanvenrooij2011}. Anti-CCP positivity at diagnosis is a strong predictor of erosive, aggressive disease. Testing is performed by enzyme-linked immunosorbent assay (ELISA) using synthetic cyclic citrullinated peptides (second-generation CCP2 assay). Automated chemiluminescent immunoassays are also used.

\section*{Alternative Names}
\begin{itemize}
  \item Anti-CCP
  \item Anti-Cyclic Citrullinated Peptide Antibody
  \item CCP Antibody
  \item ACPA (Anti-Citrullinated Protein Antibody)
  \item Anti-CCP2
  \item Citrullinated Peptide Antibody
\end{itemize}
\section*{Principle}
Anti-CCP antibodies are measured using second-generation enzyme-linked immunosorbent assay (CCP2 ELISA). Automated chemiluminescent immunoassays (CLIA) are also used. Synthetic cyclic citrullinated peptides are coated onto microtiter plates or paramagnetic microparticles. These peptides mimic the conformational epitopes of citrullinated proteins found in the rheumatoid joint. Diluted patient serum is incubated with the antigen. Anti-CCP antibodies bind during this step. After washing, an enzyme-conjugated anti-human IgG detection antibody is added. The enzyme is horseradish peroxidase or alkaline phosphatase. Following a second wash, a chemiluminescent or chromogenic substrate is added. The chromogenic substrate is tetramethylbenzidine (TMB). The resulting signal is measured photometrically or luminometrically. The signal intensity is proportional to the anti-CCP antibody concentration. Results are reported in arbitrary units (U/mL). Calibration is against a reference standard. The CCP2 assay (second generation) has superior sensitivity compared to the first-generation CCP1 assay. The CCP3 and CCP3.1 assays offer further refinements in epitope targeting.

\section*{History}
The discovery of anti-perinuclear factor (APF) in 1964 provided the first evidence for autoantibodies targeting citrullinated proteins in RA. Anti-keratin antibody (AKA) was discovered in 1979. These tests were cumbersome. They required human buccal mucosa or rat esophagus as substrate. In 1998, Walther van Venrooij and colleagues at the University of Nijmegen demonstrated that citrullinated filaggrin was the target antigen of APF and AKA \cite{schellekens1998}. They developed the first-generation CCP ELISA (CCP1) in 2000. It used linear citrullinated peptides. The CCP2 assay was introduced in 2002. It used cyclic peptides that better mimicked the native conformational epitopes. This dramatically improved sensitivity from 55\% to 75\%. It maintained >95\% specificity. A landmark finding was that anti-CCP antibodies can precede clinical RA by 5--10 years. This was reported by Aho et al. and Rantap\"a\"a-Dahlqvist et al. in the early 2000s. The 2010 ACR/EULAR classification criteria for RA formally incorporated anti-CCP as a serologic criterion. It sits alongside rheumatoid factor, reflecting its importance in RA diagnosis \cite{aletaha2010}.
...
No special preparation is required. Fasting is not necessary. Patients should inform their healthcare provider about all medications. Biologic and targeted synthetic DMARDs may lower anti-CCP levels. Antibodies rarely become completely negative with treatment.

\section*{Contraindications and Precautions}
\begin{itemize}
  \item No absolute contraindications. Specimen should be collected in a serum separator tube (SST, gold-top) or red-top tube. Grossly hemolyzed or lipemic specimens may interfere with ELISA measurements. Anti-CCP positivity is highly specific for RA. It can rarely be found in other conditions. These include psoriatic arthritis (5--10\%), active tuberculosis, chronic hepatitis C infection, and Sjogren syndrome. Unlike rheumatoid factor, anti-CCP positivity does not increase with age. It is uncommon in healthy individuals (<1--2\%). Anti-CCP antibodies are relatively stable. Serial testing for monitoring disease activity is not recommended. Clinical assessment and acute phase reactants (CRP, ESR) are preferred for monitoring.
\end{itemize}
\section*{Risks}
Minimal risk. Slight pain or bruising at the venipuncture site. Rare: hematoma, infection, vasovagal syncope.

\section*{What Happens After the Test}
Results are typically available within 1 to 3 days. A positive anti-CCP result in a patient with symmetric polyarthritis strongly supports the diagnosis of RA. It identifies patients at risk for erosive disease. A negative anti-CCP does not exclude RA. Approximately 25--35\% of patients with established RA are anti-CCP-negative (seronegative RA). If RA is strongly suspected despite negative anti-CCP and negative RF, the diagnosis is made on clinical and radiographic grounds. Your healthcare provider will interpret results in the context of your symptoms, joint examination, and inflammatory markers.
...
\begin{itemize}
  ...
  \item Early rheumatoid arthritis: A small proportion of patients with early RA are anti-CCP-negative at presentation. They may seroconvert over time. Persistent seronegativity is more common
