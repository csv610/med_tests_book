...
Sputum culture is a microbiologic test. It grows secretions from the lower respiratory tract that are coughed up (expectorated sputum) on selective and nonselective media. The test identifies bacterial, mycobacterial, or fungal pathogens that cause pneumonia, bronchitis, or other lower respiratory tract infections.

The specimen is evaluated by Gram stain for suitability. An adequate specimen has fewer than 10 squamous epithelial cells and more than 25 polymorphonuclear leukocytes per low-power field. Such a specimen is free of significant oropharyngeal contamination.

For community-acquired pneumonia (CAP), sputum culture has a sensitivity of 50--80\% and a specificity of 80--95\% for detecting the causative organism. The yield varies with specimen quality, prior antibiotic exposure, and the specific pathogen. Common pathogens include \textit{Streptococcus pneumoniae}, \textit{Haemophilus influenzae}, \textit{Moraxella catarrhalis}, \textit{Staphylococcus aureus}, \textit{Pseudomonas aeruginosa}, and members of the Enterobacterales family. The test also provides antimicrobial susceptibility data (MICs by broth microdilution or gradient diffusion). These data guide targeted therapy and detect resistance mechanisms, including extended-spectrum beta-lactamases (ESBL), carbapenemases, and MRSA.

\section*{Alternative Names}
\begin{itemize}
  \item Respiratory Culture
  \item Sputum C\&S (Culture and Sensitivity)
  \item Lower Respiratory Culture
  \item Expectorated Sputum Culture
  \item Tracheal Aspirate Culture
  \item Endotracheal Aspirate Culture
\end{itemize}
\section*{Principle}
The specimen is first evaluated by Gram stain. This assesses specimen adequacy and gives a preliminary etiologic diagnosis. Gram-positive cocci in pairs suggest pneumococcus. Gram-negative coccobacilli suggest \textit{Haemophilus}. Gram-negative rods suggest Enterobacterales or \textit{Pseudomonas}.

The specimen is then inoculated onto a panel of agar media. Sheep blood agar supports the growth of most respiratory pathogens and detects hemolysis patterns. Chocolate agar supports the growth of fastidious organisms, including \textit{H. influenzae} and \textit{Neisseria} species. MacConkey agar is selective for gram-negative rods and differentiates lactose fermenters from non-fermenters. Mannitol salt agar or colistin-nalidixic acid (CNA) agar is selective for gram-positive organisms. Plates are incubated at 35--37\textdegree{}C in 5\% CO$_2$ for 18--48 hours.

Potential pathogens are identified by colony morphology, Gram stain, biochemical tests, MALDI-TOF mass spectrometry, or automated identification systems (VITEK 2, BD Phoenix, MicroScan). Antimicrobial susceptibility testing is performed by broth microdilution, disk diffusion (Kirby-Bauer), or gradient diffusion (Etest), according to CLSI or EUCAST breakpoints. Semi-quantitative reporting (rare, few, moderate, many or 1+ to 4+) correlates with the density of the pathogen in the specimen. Organisms present in quantities below the threshold for clinical significance, or representing normal oropharyngeal flora, are reported as "normal respiratory flora" or "mixed upper respiratory flora."

\section*{History}
The use of sputum examination to diagnose tuberculosis was championed by Robert Koch in the 1880s. The Gram stain was developed by Hans Christian Gram in 1884 and quickly applied to sputum specimens to diagnose pneumonia. In the 1970s, John Bartlett systematically evaluated the utility of sputum Gram stain and culture in community-acquired pneumonia. His work established the foundational quality-assessment criteria still used today (<10 squamous epithelial cells/LPF, >25 WBC/LPF). The protected specimen brush (PSB) and bronchoalveolar lavage (BAL) were developed in the 1980s. They improved diagnostic yield and avoided oropharyngeal contamination, especially in ventilated patients. Automated blood culture systems (BACTEC, BacT/ALERT) were adapted for lower respiratory specimens. MALDI-TOF mass spectrometry for bacterial identification, introduced in the 2010s, reduced identification time from 24--48 hours to minutes. Despite the rise of molecular methods (multiplex PCR panels), sputum culture remains essential. It is still needed for antimicrobial susceptibility testing, detection of emerging resistance patterns, and recovery of organisms for epidemiologic typing.

\section*{Why This Test Is Ordered}
\begin{itemize}
  \item Diagnosis of the causative bacterial pathogen in hospitalized patients with community-acquired pneumonia (CAP), to allow targeted antimicrobial therapy and de-escalation from broad-spectrum empiric regimens
...
Sputum Gram stain and culture are primary diagnostic tests for hospitalized patients with community-acquired pneumonia. This is in accordance with IDSA/ATS guidelines, which recommend obtaining pretreatment sputum cultures in patients with severe CAP, those with risk factors for resistant pathogens, and those not responding to empiric therapy. Blood cultures are obtained concurrently. In non-severe outpatient CAP, sputum culture is generally not required. Multiplex PCR panels and urinary antigen testing complement but do not replace sputum culture, because culture provides antimicrobial susceptibility data.

\section*{How This Test Is Performed}
Specimen collection: The patient should rinse the mouth with water (not mouthwash) to reduce oral contamination. Then the patient takes a deep breath and coughs forcefully from deep within the chest to bring up sputum (not saliva). The expectorated specimen is collected directly into a sterile, leak-proof container. At least 1 mL of purulent material should be collected. Early morning specimens (first cough of the day) often have the highest yield. For patients unable to expectorate spontaneously, sputum induction with hypertonic saline (3\%) via nebulizer may be performed. In intubated patients, endotracheal aspirate or bronchoalveolar lavage (BAL) specimens are collected. Specimens should be transported to the laboratory at room temperature within 2 hours of collection, or refrigerated at 2--8\textdegree{}C if transport delay exceeds 2 hours. Anaerobic transport media is not required unless anaerobic infection is specifically suspected (lung abscess, empyema).

\section*{What Preparation Is Needed}
The patient should rinse the mouth with water immediately before specimen collection to minimize oropharyngeal contamination. The patient should not eat, drink, use mouthwash, or brush teeth for 1 hour before collection. For sputum induction, fasting for 2 hours before the procedure is recommended to reduce the risk of aspiration. Antibiotics should ideally be withheld until after specimen collection, because even a single dose can reduce culture yield by 30--50\%.

\section*{Contraindications and Precautions}
\begin{itemize}
  \item Sputum induction with hypertonic saline is contraindicated in patients with severe asthma (risk of bronchospasm), untreated pneumothorax, hemoptysis > 50 mL, or recent thoracic surgery. Spontaneous expectoration has no absolute contraindications. Sputum specimens that consist primarily of saliva (more than 10 squamous epithelial cells per LPF on Gram stain) should be rejected, because they represent oropharyngeal contamination, not lower respiratory tract secretions. Up to 30--50\% of specimens may be rejected for this reason. Previous antibiotic therapy significantly reduces culture sensitivity, particularly for fastidious organisms like \textit{S. pneumoniae}. Sputum culture cannot reliably diagnose anaerobic lung infections, because the specimen inevitably passes through the oropharynx, which harbors abundant anaerobes.
\end{itemize}
\section*{Risks}
...
Preliminary Gram stain results are available within 1--2 hours of specimen receipt. Cultures are examined at 18--24 hours. Final results, including identification and antimicrobial susceptibility, are available at 48--72 hours. Preliminary results may be communicated earlier if a dominant pathogen is identified. Empiric broad-spectrum antibiotics should be narrowed (de-escalated) to targeted therapy based on culture and susceptibility results. A negative culture at 48 hours in a patient who has not received antibiotics argues against a bacterial etiology. It should prompt consideration of alternative diagnoses or discontinuation of antibiotics. Mycobacterial cultures are incubated for 6--8 weeks.
