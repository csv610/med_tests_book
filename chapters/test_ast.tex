...
\begin{itemize}
  ...
  \item Assessment of alcoholic liver disease: AST:ALT >2:1 strongly suggests alcohol as the cause. AST rarely exceeds 300--500 IU/L in alcoholic hepatitis (unlike viral hepatitis where AST can reach >1,000 IU/L)
...
Same considerations as ALT: 8--12 hour fasting recommended when part of CMP. Alcohol intake within 24--48 hours raises AST. Hepatotoxic medications (acetaminophen, isoniazid, valproic acid) and herbal supplements (green tea extract, kava) can raise AST. Strenuous exercise within 24--48 hours can cause mild AST elevation from muscle release (more pronounced for AST than ALT due to greater muscle AST content). Intramuscular injections can cause mild AST release.
...
\begin{itemize}
  ...
  \item (3) Extensive muscle injury (rhabdomyolysis, surgery, IM injections, prolonged seizures, crush trauma) raises AST substantially, masking true liver-derived AST changes. Concurrent CK measurement distinguishes muscle from liver source.
