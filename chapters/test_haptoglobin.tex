...
\section*{History}
Polonovski and Jayle discovered haptoglobin in 1938. They identified an alpha-2 plasma globulin that bound hemoglobin and noted that this binding activity disappeared from the serum during hemolysis. In 1955, Oliver Smithies' introduction of starch gel electrophoresis revealed hereditary polymorphism of haptoglobin (types 1-1, 2-1, and 2-2), making it one of the first human protein polymorphisms studied in populations \cite{smithies1955zone}. Hwang and Greer showed in 1980 that hemoglobin binds to haptoglobin extremely tightly (dissociation constant on the order of 10$^{-15}$ M). The clearance pathway was fully defined in 2001, when Kristiansen and colleagues identified CD163 as the macrophage hemoglobin scavenger receptor \cite{kristiansen2001identification}. Immunoturbidimetric and immunonephelometric assays replaced earlier methods from the 1970s onward. This established routine clinical measurement of haptoglobin as the most sensitive laboratory marker of intravascular hemolysis.
...
A blood sample is collected by standard venipuncture into a plain serum tube or serum separator tube. Haptoglobin is measured by immunoturbidimetry or immunonephelometry, in which anti-haptoglobin antibodies form immune complexes in proportion to the haptoglobin concentration. The resulting turbidity or light scattering is quantified on an automated analyzer. Results are reported in mg/dL. Turnaround time is typically the same day.
...
\begin{itemize}
  ...
  \item (1) Haptoglobin is an acute phase reactant and rises in inflammation, infection, malignancy, and trauma, so a normal or elevated value does not exclude hemolysis in a patient with concurrent inflammation.
  \item (2) Low haptoglobin also occurs with reduced hepatic synthesis (cirrhosis, end-stage liver disease, malnutrition) and in neonates, who have physiologically low levels.
  \item (3) Very low haptoglobin can cause spurious increases in unconjugated (indirect) bilirubin measured by some automated methods because of hemoglobin interference.
  \item (4) Massive acute hemorrhage can lower haptoglobin transiently through dilution and consumption.
\end{itemize}
\section*{Risks}
