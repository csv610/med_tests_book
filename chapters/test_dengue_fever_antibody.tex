...
\begin{itemize}
  \item Dengue serology
  \item Dengue IgM and IgG
  \item Dengue NS1 antigen test
  \item Dengue PCR
\end{itemize}
...
This test is ordered when a patient presents with sudden high fever, severe headache, retro-orbital (behind-the-eye) pain, severe joint and muscle pain (``breakbone fever''), rash, or minor bleeding, particularly after traveling to tropical or subtropical regions where dengue is endemic \cite{who2009dengue}.
...
A negative result (no NS1 antigen or antibodies detected) suggests that Dengue virus is not the cause of the illness. However, if the blood was drawn too early, antibodies may not yet have developed.

\subsection*{Above Normal}
\begin{itemize}
  \item \textbf{Positive NS1 or IgM:} Confirms an active or very recent Dengue virus infection.
  \item \textbf{Positive IgG only:} Indicates a past Dengue virus infection.
  \item \textbf{Highly elevated IgG with positive IgM:} Suggests a secondary dengue infection, which carries a higher risk of severe dengue complications \cite{simmons2012dengue}.
\end{itemize}
