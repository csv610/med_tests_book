...
\begin{itemize}
  \item Chlamydia NAAT
  \item CT PCR
  \item \textit{C. trachomatis} test
  \item chlamydia culture
  \item CT/NG NAAT
\end{itemize}
\section*{Principle}
