...
\begin{itemize}
  ...
  \item c-ANCA
  \item p-ANCA
  \item vasculitis antibody testing
\end{itemize}
\section*{Principle}
...
PR3/MPO immunoassay is a primary supportive test when clinical suspicion for AAV is appropriate. A positive result is not diagnostic by itself and does not automatically replace tissue diagnosis. Biopsy is pursued when needed to establish the diagnosis, define organ involvement, or exclude competing disease. In a life-threatening presentation, treatment should not be delayed solely to await a biopsy when specialist assessment supports immediate therapy.
...
\begin{itemize}
  \item There are no absolute contraindications to venipuncture. A positive PR3 or MPO result contributes to the diagnostic workup but is not diagnostic alone. A negative result does not exclude AAV. IIF patterns can be positive in inflammatory bowel disease, autoimmune liver disease, infection, and drug-induced autoimmunity. Serial ANCA titers should not be used alone to guide treatment or define relapse.
\end{itemize}
\section*{Risks}
Minimal venipuncture risks include brief pain, bruising, hematoma, and vasovagal symptoms.

\section*{What Happens After the Test}
Interpret the result with urinalysis, creatinine/eGFR, inflammatory markers, imaging, symptoms, and examination. PR3 positivity supports GPA and MPO positivity supports MPA or EGPA in the appropriate clinical setting, but neither is enough to establish the diagnosis. Kidney, skin, lung, nerve, or other tissue biopsy may be required. Urgent specialist assessment is needed for suspected pulmonary-renal syndrome or rapidly progressive organ injury.
