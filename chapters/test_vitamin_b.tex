...
\begin{itemize}
  \item To evaluate suspected vitamin B6 deficiency in patients with peripheral neuropathy, microcytic or sideroblastic anemia, seborrheic dermatitis, glossitis, or cheilitis
  \item For workup of unexplained hyperhomocysteinemia, since PLP is a cofactor for homocysteine catabolism
  \item To assess deficiency risk in alcoholism, malabsorption, older adults, and patients taking isoniazid or penicillamine
  \item To evaluate infantile seizures when pyridoxine-dependent epilepsy (antiquitin deficiency) is suspected
  \item To monitor patients with chronic renal failure or on dialysis, who lose PLP with treatment
  \item To document pyridoxine toxicity in patients with sensory neuropathy taking high-dose supplements ($>$200 mg/day)
\end{itemize}
...
\begin{itemize}
  ...
  \item (4) recent B6 supplementation raises PLP and may mask deficiency.
\end{itemize}
\section*{Risks}
...
Serum homocysteine (B6 deficiency raises it), CBC (microcytic anemia), serum transaminases (AST/ALT are PLP-dependent, levels may be low in B6 deficiency), tryptophan loading test (elevated xanthurenic acid in urine after tryptophan load). Isoniazid-related deficiency: prophylactic pyridoxine 25--50 mg/day.
\section*{References}
\begin{enumerate}
