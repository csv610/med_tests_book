...
No contraindications to standard venipuncture. Precautions: (1) The sample must be shielded from light and processed promptly because PLP degrades on exposure; (2) hemolyzed specimens are unreliable because red blood cells contain substantial PLP that falsely raises the measured level; (3) renal failure and hypoalbuminemia alter PLP levels and complicate interpretation; and (4) recent B6 supplementation elevates PLP and may mask deficiency.
\section*{Risks}
