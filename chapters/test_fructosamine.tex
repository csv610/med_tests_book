...
Fructosamine measures glycated serum proteins, mainly glycated albumin. It reflects average blood-glucose exposure over approximately the preceding two to three weeks. This is a shorter period than the two- to three-month period reflected by hemoglobin A1c.

\section*{Alternative Names}
\begin{itemize}
  \item Glycated Serum Protein
  \item Glycated Albumin-Related Test
  \item Serum Fructosamine
\end{itemize}
