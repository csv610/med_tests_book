...
\begin{itemize}
  ...
  \item Cytogenetic Analysis
  \item Karyogram
  \item G-Banding
  \item Metaphase Chromosome Analysis
  \item Giemsa Banding
  \item Constitutional Karyotype
  \item Leukemia Karyotype
\end{itemize}
\section*{Principle}
