...
\begin{itemize}
  \item Tg
  \item Serum Thyroglobulin
  \item Thyroglobulin Tumor Marker
  \item hTg
  \item Tg by Immunoassay
  \item Thyroglobulin RIA
  \item Thyroglobulin Cancer Marker
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  ...
  \item \textbf{FDG-PET/CT:} Indicated for Tg >10 ng/mL with negative I-131 whole-body scan (TENIS syndrome --- Tg-Elevated Negative Iodine Scan), suggesting dedifferentiated/RAI-refractory disease. FDG-avid disease carries a worse prognosis.
