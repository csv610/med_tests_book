...
\begin{itemize}
  ...
  \item \textbf{Culture positive for \textit{Legionella} species:} Definitive diagnosis. Allows species and serogroup identification, which is critical for outbreak source identification (molecular typing of clinical and environmental isolates by pulsed-field gel electrophoresis/PFGE or whole-genome sequencing/WGS). The most common isolates are \textit{L. pneumophila} serogroup 1 (70--90\%), \textit{L. micdadei} (Pittsburgh pneumonia agent), and \textit{L. longbeachae} (linked to compost/potting soil)
