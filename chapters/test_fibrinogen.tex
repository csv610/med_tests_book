...
Results are available within 30--60 minutes. In DIC evaluation, fibrinogen is interpreted with platelet count, PT, aPTT, and D-dimer \cite{tierney2023current}. Fibrinogen <100 mg/dL in DIC represents severe consumption and is a criterion for DIC diagnosis. In massive hemorrhage, fibrinogen <150--200 mg/dL is the threshold for fibrinogen replacement with cryoprecipitate or fibrinogen concentrate. If Clauss fibrinogen is significantly lower than fibrinogen antigen (immunologic assay), dysfibrinogenemia is suspected and further evaluation by thrombin time, reptilase time, and genetic testing may be pursued.
