...
\begin{itemize}
  ...
  \item Diagnosis and evaluation of polycystic ovary syndrome (PCOS): AMH is often high and is increasingly recognized as a useful adjunct to the Rotterdam criteria
...
\begin{itemize}
  \item A high AMH (>3.0-4.0 ng/mL) is commonly associated with polycystic ovary syndrome (PCOS).
  ...
  \item Other causes of high AMH: multiple small antral follicles, some ovarian granulosa cell tumors (though these typically produce very high levels >10 ng/mL).
