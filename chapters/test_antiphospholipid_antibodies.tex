...
Antiphospholipid antibody testing evaluates antibodies linked to antiphospholipid syndrome. The principal laboratory components are lupus anticoagulant testing, anticardiolipin IgG or IgM, and anti-beta-2-glycoprotein I IgG or IgM.

\section*{Alternative Names}
\begin{itemize}
  \item APS Panel
  \item Anticardiolipin Antibodies
  \item Anti-beta-2-Glycoprotein I
  \item Lupus Anticoagulant
  \item Thrombophilia Antibody Testing
\end{itemize}
...
Blood is collected for phospholipid-dependent clotting assays and immunoassays. A positive result generally requires repeat testing at least 12 weeks later to show persistence. Anticoagulants can interfere with lupus-anticoagulant testing.
