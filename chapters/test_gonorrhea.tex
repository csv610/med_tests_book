...
\begin{itemize}
  ...
  \item gonorrhea NAAT
  \item GC PCR
  \item gonococcal culture
  \item GC culture and susceptibility
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  \item There are no absolute contraindications to urine or swab collection. A negative result applies only to the tested site. Routine test of cure is not recommended for uncomplicated urogenital or rectal gonorrhea treated with a recommended regimen. Pharyngeal gonorrhea requires test of cure at 7--14 days after treatment. Suspected treatment failure requires culture, preferably with simultaneous NAAT, and antimicrobial susceptibility testing. Do not interpret a positive NAAT alone as evidence of viable organisms immediately after treatment.
\end{itemize}
\section*{Risks}
