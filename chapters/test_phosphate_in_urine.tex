...
\begin{itemize}
  ...
  \item Diagnosis of X-linked hypophosphatemic rickets (XLH): FGF23 excess from a PHEX mutation causes severe renal phosphate wasting, hypophosphatemia, low calcitriol, rickets, and osteomalacia. FEPO4 is elevated despite hypophosphatemia \cite{carpenter2011clinicians}
...
For an accurate FEPO4 or 24-hour urine phosphate, the patient should be on their usual diet. A very-low-phosphate diet will reduce urine phosphate; a high-phosphate diet will increase it. Fasting is not required for the spot FEPO4. Tell the provider about medications affecting urine phosphate: (1) Increase phosphaturia: PTH, loop diuretics, acetazolamide, glucocorticoids, calcitonin, bisphosphonates, phosphate binders, cinacalcet, denosumab. (2) Decrease phosphaturia (increase reabsorption): vitamin D/calcitriol, growth hormone, thyroid hormone, thiazide diuretics, bisphosphonates (variable effect). Time of day: urine phosphate excretion has a diurnal rhythm (highest in the afternoon, lowest in early morning) \cite{portale1987dietary}. Ideally, samples should be collected at the same time of day for repeat measurements.

\section*{Contraindications and Precautions}
\begin{itemize}
  \item No absolute contraindications. Important considerations:
  \item (1) FEPO4 values must be interpreted in the clinical context of the serum phosphate level. An FEPO4 of 10\% may be normal if serum phosphate is normal, but it is inappropriately high if the patient is hypophosphatemic (PO4 <2.5 mg/dL), where FEPO4 should be <5\%.
  \item (2) The tubular maximum reabsorption of phosphate per GFR (TmP/GFR = TRP $\times$ serum PO4) is a more precise index of renal phosphate handling than FEPO4. TmP/GFR <2.5 mg/dL indicates renal phosphate wasting. Nomograms are available \cite{walton1975nomogram}.
  \item (3) An incomplete 24-hour collection invalidates results---check 24-hour urine creatinine against the expected range.
  \item (4) FEPO4 is influenced by dietary phosphate intake in the preceding days.
  \item (5) An acidified urine container is essential---if not acidified, calcium phosphate precipitates, falsely lowering measured phosphate.
  \item (6) FEPO4 changes with age: higher in children (growth, higher PTH), lower in the elderly.
\end{itemize}
\section*{Risks}
No direct risk from urine collection. A blood draw is required for simultaneous serum phosphate and creatinine measurements for the FEPO4 calculation; risks are minimal (mild pain/bruising from venipuncture).

\section*{What Happens After the Test}
Results are available in 1--2 days. Interpretation of FEPO4 in hypophosphatemia: FEPO4 <5\% in a hypophosphatemic patient indicates appropriate renal phosphate conservation, suggesting that the cause of hypophosphatemia is GI loss (diarrhea, phosphate binders, vitamin D deficiency with decreased absorption), transcellular shift (refeeding syndrome, insulin therapy, respiratory alkalosis, hungry bone syndrome), or decreased intake. FEPO4 >5--20\% in a hypophosphatemic patient indicates inappropriate renal phosphate wasting, suggesting primary hyperparathyroidism, FGF23-mediated phosphate wasting (XLH, oncogenic osteomalacia), Fanconi syndrome, or post-renal transplant \cite{imel2012approach}. TmP/GFR is often reported and divides results into three groups: (a) NL (normal, >3.5 mg/dL), appropriate renal phosphate conservation; (b) LOW (<2.5 mg/dL), renal phosphate wasting; (c) marginal (2.5--3.5 mg/dL). For XLH and oncogenic osteomalacia, TmP/GFR is typically <2.0--2.5 mg/dL with hypophosphatemia and low or inappropriately normal calcitriol.
...
\begin{itemize}
  ...
  \item \textbf{Acetazolamide therapy:} A carbonic anhydrase inhibitor causing proximal tubular phosphate loss.
...
\begin{itemize}
  \item \textbf{Serum phosphate, calcium, PTH:} Essential for the differential diagnosis of renal phosphate wasting.
  \item \textbf{25-hydroxyvitamin D and 1,25-dihydroxyvitamin D:} Low calcitriol with elevated FEPO4 suggests an FGF23-mediated process.
  \item \textbf{Serum FGF23 (intact and C-terminal):} Elevated in XLH, ADHR, oncogenic osteomalacia, and CKD. Order if FGF23-mediated phosphate wasting is suspected with no other explanation.
  ...
  \item \textbf{Whole-body imaging:} To localize the tumor in suspected oncogenic osteomalacia (MRI, octreotide scan, FDG-PET/CT with DOTATATE).
