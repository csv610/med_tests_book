...
\begin{itemize}
  ...
  \item (3) Incomplete 24-hour collection invalidates results---check 24-hour urine creatinine against expected range.
  \item (4) FEPO4 is influenced by dietary phosphate intake in the preceding days.
  \item (5) Acidified urine container is essential---if not acidified, calcium phosphate precipitates, falsely lowering measured phosphate.
  \item (6) FEPO4 changes with age: higher in children (growth, higher PTH), lower in elderly.
\end{itemize}
\section*{Risks}
