...
\begin{itemize}
  \item Heavy Metal Panel
  \item Lead Level
  \item Mercury Level
  \item Arsenic Level
  \item Cadmium Level
  \item Toxic Metal Screen
  \item Heavy Metal Blood Test
  \item Heavy Metal Urine Test
\end{itemize}
\section*{Principle}
...
\begin{itemize}
  \item Specimens are easily contaminated by collection equipment; only royal blue-top trace-element tubes are acceptable for blood. Glass containers may leach contaminants. Hair analysis has no clinical role for toxicity assessment; alternative practitioners use it, but it is not regulated.
\end{itemize}
\section*{Risks}
Venipuncture only.
...
A normal result reduces concern for chronic toxicity but does not exclude past exposure or body burden (metals accumulate in bone, kidney, brain). Hair analysis is unreliable.
