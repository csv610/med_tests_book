...
\begin{itemize}
  \item Specimens easily contaminated by collection equipment; only royal blue-top trace-element tubes are acceptable for blood. Glass containers may leach contaminants. Hair analysis has no clinical role for toxicity assessment; alternative practitioners use it but is not regulated.
\end{itemize}
\section*{Risks}
Venipuncture only.
